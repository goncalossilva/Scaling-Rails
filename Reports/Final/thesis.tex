...
%%========================================
%% Hyphenation
\hyphenation{pha-ses meta-programming resour-ces make-overs per-iods ar-ound data-base}
%%========================================
...
\begin{document}
  ...
  \StartPrelim
  \begin{singlespace}
    \include{setup_abstract}
    %\include{setup_acknowledgements}
    \include{setup_quote}    % initial quotation if desired
    \cleardoublepage
  ...
  %% Introduction
  \include{body_introduction}
  %% Technologies review
  \include{body_technologies_review}
  %% State Of The Art
  \include{body_state_of_the_art}
  %% State Of The Art
  \include{body_problem_statement}
  %% Problem Approach and Results
  \include{body_problem_approach_and_results}
  %% Conclusions
  \include{body_conclusions}
  ...
  \begin{singlespace}
    ...
    \appendix
    \include{appendix_a_ruby19_encoding_patch}
    \include{appendix_b_ruby19_encoding_task}
    \include{appendix_c_ruby19_configuration}
    \include{appendix_d_ruby-prof_html_stack_printer}
    \include{appendix_e_monitor}
    \include{appendix_f_mysql2_patch}
    \include{appendix_g_scaling_rails}
    %\include{appendix_b}
  \end{singlespace}
\end{document}
