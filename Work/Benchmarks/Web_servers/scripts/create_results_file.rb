...
webservers = ["cherokee_thin","apache2_thin","nginx_thin","cherokee_thin_threaded","apache2_thin_threaded","nginx_thin_threaded","apache2_passenger","nginx_passenger"]
